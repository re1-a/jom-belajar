...
const unit2Data = [
    { type: 'mcq', image: 'images/fox_peraturan.png?v=2', q: 'Di manakah sisa pepejal perlu dibuang di Bilik Sains?', options: ['Di lantai', 'Di dalam singki', 'Di dalam bakul sampah'], answer: 'Di dalam bakul sampah', exp: 'Sisa pepejal seperti mancis, kayu, dan kertas tidak boleh dibuang dalam singki kerana akan menyumbatkannya.' },
    { type: 'mcq', image: 'images/fox_peraturan.png?v=2', q: 'Mengapa murid perlu melaporkan kecederaan (contoh: luka kecil) kepada guru?', options: ['Untuk mengelakkan dimarahi', 'Untuk mendapatkan rawatan segera', 'Untuk bermain di luar kelas'], answer: 'Untuk mendapatkan rawatan segera', exp: 'Guru perlu dimaklumkan segera supaya murid boleh dirawat dan bahan berbahaya di tempat kejadian dapat dibersihkan.' },
    { type: 'tf', image: 'images/fox_peraturan.png?v=2', q: 'Murid boleh masuk ke dalam Bilik Sains tanpa kebenaran guru jika tiada siapa di dalam.', answer: false, exp: 'Kita mesti beratur dan tunggu kebenaran guru sebelum masuk untuk mengelakkan bahaya.' },
    { type: 'tf', image: 'images/fox_peraturan.png?v=2', q: 'Makan dan minum dilarang sama sekali di dalam Bilik Sains.', answer: true, exp: 'Makanan dan minuman boleh tercemar dengan wap bahan kimia beracun.' },
    { type: 'mcq', image: 'images/fox_peraturan.png?v=2', q: 'Apakah yang perlu dilakukan jika buret atau bikar kaca pecah?', options: ['Kutip dengan tangan', 'Laporkan kepada guru', 'Buang dalam bakul sampah segera'], answer: 'Laporkan kepada guru', exp: 'Guru akan membersihkannya menggunakan cara yang selamat. Jangan kutip guna tangan kosong.' },
    { type: 'drag', image: 'images/fox_peraturan.png?v=2', q: 'Kelaskan perbuatan berikut di dalam Bilik Sains',
    ...
    { type: 'mcq', image: 'images/fox_peraturan.png?v=2', q: 'Mengapakah tingkap dan pintu perlu dibuka semasa berada di Bilik Sains?', options: ['Supaya nyamuk masuk', 'Untuk pengudaraan yang baik', 'Kerana panas'], answer: 'Untuk pengudaraan yang baik', exp: 'Supaya udara segar dapat masuk dan gas atau bau bahan kimia dapat keluar.' },
    { type: 'tf', image: 'images/fox_peraturan.png?v=2', q: 'Sampah cecair yang selamat boleh dibuang ke dalam singki dengan membuka air paip.', answer: true, exp: 'Cecair yang dibenarkan oleh guru sahaja boleh masuk singki.' },
    { type: 'mcq', image: 'images/fox_peraturan.png?v=2', q: 'Apakah tindakan yang betul sebelum meninggalkan Bilik Sains?', options: ['Tinggalkan kerusi bersepah', 'Tutup suis kipas dan lampu', 'Biar radas tidak dicuci'], answer: 'Tutup suis kipas dan lampu', exp: 'Pastikan keadaan selamat, kemas, dan menjimatkan elektrik.' },
    { type: 'drag', image: 'images/fox_peraturan.png?v=2', q: 'Di manakah tempat buangan yang betul?',
...
// UNIT 3: Manusia
const unit3Data = [
    { type: 'mcq', image: 'images/fox_pewarisan.png?v=2', q: 'Manakah urutan peringkat tumbesaran manusia yang betul?', options: ['Kanak-kanak → Bayi → Dewasa → Remaja', 'Bayi → Kanak-kanak → Remaja → Dewasa', 'Remaja → Kanak-kanak → Bayi → Dewasa'], answer: 'Bayi → Kanak-kanak → Remaja → Dewasa', exp: 'Manusia mula hidup sebagai Bayi, kemudian membesar jadi Kanak-Kanak, Remaja, dan akhirnya Dewasa.' },
    { type: 'mcq', image: 'images/fox_membesar.png?v=2', q: 'Apakah perubahan utama apabila tumbesaran manusia meningkat?', options: ['Kematangan mental sahaja', 'Saiz, berat, dan tinggi bertambah', 'Warna kulit berubah'], answer: 'Saiz, berat, dan tinggi bertambah', exp: 'Fizikal kita berubah apabila membesar. Saiz badan bertambah besar, berat bertambah, dan tinggi makin bertambah.' },
    { type: 'mcq', image: 'images/fox_tumbesaranku.png?v=2', q: 'Ciri manakah yang boleh diwarisi daripada ibu bapa atau keturunan kita?', options: ['Saiz kasut', 'Cara berjalan', 'Warna iris mata'], answer: 'Warna iris mata', exp: 'Warna mata, jenis rambut, dan warna kulit adalah genetik yang diwarisi daripada ibu bapa.' },
    { type: 'mcq', image: 'images/fox_pewarisan.png?v=2', q: 'Manusia membiak secara...', options: ['Melahirkan anak', 'Bertelur', 'Biji benih'], answer: 'Melahirkan anak', exp: 'Manusia adalah kumpulan mamalia yang membiak dengan cara melahirkan anak.' },
    { type: 'drag', image: 'images/fox_tumbesaranku.png?v=2', q: 'Susun peringkat tumbesaran manusia',
    ...
    { type: 'tf', image: 'images/fox_tumbesaran.png?v=2', q: 'Semakin kita membesar, saiz baju yang kita pakai pada waktu bayi akan menjadi ketat.', answer: true, exp: 'Ini kerana tumbesaran menyebabkan saiz badan, tinggi, dan berat kita bertambah.' },
    { type: 'tf', image: 'images/fox_membesar.png?v=2', q: 'Anak mungkin mempunyai jenis rambut yang keriting seperti datuknya walaupun rambut bapanya lurus.', answer: true, exp: 'Ciri keturunan (pewarisan) juga boleh diwarisi daripada datuk atau nenek moyang kita.' },
    { type: 'drag', image: 'images/fox_pewarisan.png?v=2', q: 'Kelaskan ciri-ciri manusia di bawah',
    ...
    { type: 'mcq', image: 'images/fox_tumbesaran.png?v=2', q: 'Seseorang individu yang tidak mewarisi ciri fizikal ibu bapanya secara terus, mungkin mewarisi ciri tersebut daripada...', options: ['Kawan rapat', 'Datuk atau Nenek', 'Jiran tetangga'], answer: 'Datuk atau Nenek', exp: 'Ciri-ciri ini dinamakan pewarisan keturunan dalam salasilah keluarga.' },
    { type: 'tf', image: 'images/fox_membesar.png?v=2', q: 'Warna kulit seseorang adalah contoh ciri pewarisan.', answer: true, exp: 'Warna kulit dipengaruhi kuat oleh genetik ibu bapa.' }
];
...
// UNIT 4: Haiwan
const unit4Data = [
    { type: 'mcq', image: 'images/fox_membiak.png?v=2', q: 'Haiwan manakah yang mempunyai kepak dan berkaki dua?', options: ['Itik', 'Tenuk', 'Cacing'], answer: 'Itik', exp: 'Itik ialah contoh burung yang mempunyai kepak dan dua kaki.' },
    { type: 'mcq', image: 'images/fox_kitar.png?v=2', q: 'Haiwan manakah yang melahirkan anak dalam bilangan sedikit?', options: ['Arnab', 'Kucing', 'Ikan lumba-lumba'], answer: 'Ikan lumba-lumba', exp: 'Paus dan ikan lumba-lumba melahirkan anak yang sedikit berbanding arnab dan kucing yang melahirkan banyak anak.' },
    { type: 'mcq', image: 'images/fox_haiwan_membiak.png?v=2', q: 'Apakah persamaan antara arnab dan kucing dalam cara membiak?', options: ['Bertelur sedikit', 'Melahirkan anak sedikit', 'Melahirkan anak banyak'], answer: 'Melahirkan anak banyak', exp: 'Kucing dan arnab kedua-duanya melahirkan banyak anak (beberapa ekor sekaligus) pada satu-satu masa.' },
    { type: 'mcq', image: 'images/fox_bertelur.png?v=2', q: 'Apakah kepentingan haiwan mengeram dan menjaga telurnya di dalam sarang?', options: ['Supaya boleh dijual', 'Supaya telur nampak cantik', 'Supaya tidak dimakan haiwan lain'], answer: 'Supaya tidak dimakan haiwan lain', exp: 'Sarang dan penjagaan rapi melindungi telur daripada bahaya cuaca serta musuh.' },
    { type: 'mcq', image: 'images/fox_bertelur.png?v=2', q: 'Haiwan apakah yang bertelur dalam kuantiti yang sangat banyak?', options: ['Kucing', 'Penyu', 'Ayam'], answer: 'Penyu', exp: 'Penyu bertelur beratus-ratus biji kerana kebarangkalian telurnya dimakan haiwan pemangsa lain adalah tinggi.' },
    { type: 'drag', image: 'images/fox_bertelur.png?v=2', q: 'Kelaskan haiwan mengikut cara pembiakan',
    ...
    { type: 'drag', image: 'images/fox_serupa.png?v=2', q: 'Susun kitaran hidup katak mengikut urutan',
    ...
    { type: 'tf', image: 'images/fox_membiak.png?v=2', q: 'Semua anak haiwan di dunia ini menyerupai rupa ibu bapanya sejurus dilahirkan.', answer: false, exp: 'Contohnya berudu lansung tidak menyerupai katak dewasa, begitu juga beluncas yang tidak sama dengan rama-rama.' },
    { type: 'drag', image: 'images/fox_serupa.png?v=2', q: 'Padankan anak dengan ibunya',
...
const unit5Data = [
    { type: 'mcq', image: 'images/fox_biji_benih.png?v=2', q: 'Tumbuh-tumbuhan sangat penting kerana ia membekalkan...', options: ['Pakaian dan elektrik', 'Oksigen dan makanan', 'Plastik'], answer: 'Oksigen dan makanan', exp: 'Tumbuhan menghasilkan oksigen dan menjadi sumber makanan untuk manusia serta haiwan.' },
    { type: 'tf', image: 'images/fox_biji_benih.png?v=2', q: 'Biji benih memerlukan cahaya matahari untuk mula bercambah.', answer: false, exp: 'Biji benih HANYA memerlukan air, udara dan suhu yang sesuai untuk bercambah. Cahaya matahari belum diperlukan sehingga ia mempunyai daun.' },
    { type: 'drag', image: 'images/fox_biji_benih.png?v=2', q: 'Kelaskan keperluan asas',
    ...
    { type: 'mcq', image: 'images/fox_keperluan.png?v=2', q: 'Apakah yang akan bertambah apabila pokok membesar?', options: ['Jumlah daun', 'Warna bunga', 'Jenis buah'], answer: 'Jumlah daun', exp: 'Bila pokok membesar, jumlah daun, saiz daun, lilitan batang dan tingginya bertambah.' },
    { type: 'drag', image: 'images/fox_urutan.png?v=2', q: 'Susun urutan tumbesaran pokok',
    ...
    { type: 'tf', image: 'images/fox_urutan.png?v=2', q: 'Tumbuhan yang tidak disiram air akan mati layu.', answer: true, exp: 'Air merupakan keperluan asas yang sangat penting.' },
    { type: 'mcq', image: 'images/fox_biji_benih.png?v=2', q: 'Jika anak pokok ditutup rapat dengan kotak plastik jernih tanpa lubang, apakah yang akan berlaku?', options: ['Pokok tumbuh tinggi', 'Pokok akan mati', 'Pokok berbunga lebat'], answer: 'Pokok akan mati', exp: 'Ia mati kerana ketiadaan udara segar (karbon dioksida) untuk membuat makanan.' },
    { type: 'tf', image: 'images/fox_urutan.png?v=2', q: 'Pokok menghasilkan makanannya sendiri.', answer: true, exp: 'Proses ini dipanggil fotosintesis, menggunakan cahaya matahari.' },
    { type: 'mcq', image: 'images/fox_urutan.png?v=2', q: 'Apakah urutan yang betul tumbesaran buah tembikai?', options: ['Biji -> Bunga -> Buah', 'Biji -> Anak pokok -> Bunga -> Buah', 'Bunga -> Biji -> Buah'], answer: 'Biji -> Anak pokok -> Bunga -> Buah', exp: 'Ini adalah kitaran hidup tumbuhan yang berbuah.' },
    { type: 'tf', image: 'images/fox_urutan.png?v=2', q: 'Semasa membesar, batang pokok menjadi semakin besar (lilitan bertambah).', answer: true, exp: 'Ya, lilitan batang pokok adalah salah satu penunjuk bahawa ia membesar.' }
];
...
const unit6Data = [
    { type: 'mcq', image: 'images/fox_permainan_bayang.png?v=2', q: 'Sumber cahaya yang utama untuk bumi ialah...', options: ['Matahari', 'Bulan', 'Lampu suluh'], answer: 'Matahari', exp: 'Matahari ialah sumber cahaya semula jadi yang paling besar dan utama.' },
    { type: 'tf', image: 'images/fox_sumber_cahaya.png?v=2', q: 'Bulan adalah sumber cahaya semula jadi.', answer: false, exp: 'Bulan tidak mengeluarkan cahaya sendiri, ia memantulkan cahaya matahari.' },
    { type: 'drag', image: 'images/fox_permainan_bayang.png?v=2', q: 'Kelaskan sumber cahaya ini',
    ...
    { type: 'tf', image: 'images/fox_permainan_bayang.png?v=2', q: 'Dalam keadaan terang, kita lebih mudah melihat objek berbanding dalam keadaan gelap.', answer: true, exp: 'Mata memerlukan cahaya untuk melihat sesuatu objek.' },
    { type: 'mcq', image: 'images/fox_wayang_kertas.png?v=2', q: 'Apakah yang terjadi kepada bayang-bayang apabila lampu suluh didekatkan kepada objek?', options: ['Menjadi kecil', 'Menjadi besar', 'Hilang'], answer: 'Menjadi besar', exp: 'Semakin dekat sumber cahaya dengan objek, semakin besar saiz bayang-bayang.' },
    { type: 'drag', image: 'images/fox_terang_gelap.png?v=2', q: 'Permainan bayang-bayang selalunya menggunakan...',
    ...
    { type: 'tf', image: 'images/fox_wayang_kertas.png?v=2', q: 'Bayang-bayang bagi bola akan berbentuk bulat.', answer: true, exp: 'Bentuk bayang-bayang menyerupai bentuk objek yang menghalang cahaya.' },
    { type: 'mcq', image: 'images/fox_wayang_kertas.png?v=2', q: 'Objek yang paling jelas menghasilkan bayang-bayang gelap dinamakan...', options: ['Objek Lut Sinar', 'Objek Legap', 'Objek Kaca'], answer: 'Objek Legap', exp: 'Objek legap (seperti kayu atau logam) menghalang seluruh cahaya daripada melaluinya.' },
    { type: 'tf', image: 'images/fox_terang_gelap.png?v=2', q: 'Membaca di tempat gelap boleh membuatkan mata kita berasa cepat letih.', answer: true, exp: 'Kekurangan cahaya menyebabkan mata terpaksa bekerja lebih keras.' }
];
...
const unit7Data = [
    ...
    { type: 'drag', image: 'images/fox_konduktor.png?v=2', q: 'Padankan fungsi komponen elektrik',
    ...
    { type: 'tf', image: 'images/fox_konduktor.png?v=2', q: 'Lampu akan menyala jika litar elektrik adalah litar terbuka (suis ditutup/off).', answer: false, exp: 'Lampu hanya menyala dalam litar TERTUTUP (suis dipasang/on) di mana arus elektrik boleh mengalir.' },
    { type: 'mcq', image: 'images/fox_bina_litar.png?v=2', q: 'Jika mentol dalam litar tidak menyala, apakah puncanya?', options: ['Wayar disambung dengan betul', 'Sel kering baharu', 'Mentol telah rosak/terbakar'], answer: 'Mentol telah rosak/terbakar', exp: 'Mentol yang rosak atau sel kering yang kehabisan tenaga menyebabkan litar tidak berfungsi.' },
    { type: 'tf', image: 'images/fox_mentol_tak_nyala.png?v=2', q: 'Alat permainan kereta kawalan jauh selalunya menggunakan kuasa elektrik daripada sel kering (bateri).', answer: true, exp: 'Ia menggunakan bateri untuk membekalkan elektrik.' },
    { type: 'drag', image: 'images/fox_kenali_komponen.png?v=2', q: 'Kelaskan barangan',
    ...
    { type: 'mcq', image: 'images/fox_fungsi_komponen.png?v=2', q: 'Bahan manakah yang BUKAN merupakan konduktor elektrik (tidak membenarkan elektrik mengalir)?', options: ['Paku Besi', 'Sudu Besi', 'Pemadam Getah'], answer: 'Pemadam Getah', exp: 'Getah, plastik dan kayu adalah penebat (penghalang) elektrik.' },
    { type: 'tf', image: 'images/fox_kenali_komponen.png?v=2', q: 'Kita tidak boleh menyentuh suis dengan tangan yang basah.', answer: true, exp: 'Air ialah konduktor elektrik yang boleh menyebabkan kita terkena renjatan elektrik.' },
    { type: 'mcq', image: 'images/fox_kenali_komponen.png?v=2', q: 'Apakah fungsi wayar dalam litar elektrik?', options: ['Menyambungkan komponen litar', 'Membekalkan cahaya', 'Mematikan elektrik'], answer: 'Menyambungkan komponen litar', exp: 'Wayar membenarkan arus elektrik mengalir menghubungkan komponen.' },
    { type: 'tf', image: 'images/fox_kenali_komponen.png?v=2', q: 'Sel kering mempunyai dua terminal iaitu terminal positif (+) dan terminal negatif (-).', answer: true, exp: 'Pemasangan bateri mesti selari dengan terminal yang betul supaya elektrik dapat mengalir.' }
];
...
// UNIT 8: Campuran
const unit8Data = [
    { type: 'mcq', image: 'images/fox_asing.png?v=2', q: 'Proses memisahkan serbuk besi daripada pasir boleh dilakukan menggunakan...', options: ['Tapis', 'Magnet', 'Tangan'], answer: 'Magnet', exp: 'Magnet menarik serbuk besi dan meninggalkan pasir.' },
    { type: 'tf', image: 'images/fox_boleh_larut.png?v=2', q: 'Garam akan hilang (larut) jika dikacau di dalam air.', answer: true, exp: 'Garam adalah bahan yang boleh larut di dalam air.' },
    { type: 'drag', image: 'images/fox_boleh_larut.png?v=2', q: 'Kelaskan bahan ini jika dicampurkan dalam air',
    ...
    { type: 'mcq', image: 'images/fox_larut_cepat.png?v=2', q: 'Cara terbaik untuk mempercepatkan gula larut di dalam air ialah dengan menggunakan air...', options: ['Air Sejuk', 'Air Panas', 'Air Paip Biasa'], answer: 'Air Panas', exp: 'Bahan larut lebih cepat di dalam air panas berbanding air sejuk.' },
    { type: 'tf', image: 'images/fox_larut_cepat.png?v=2', q: 'Kita boleh memisahkan campuran campuran kacang hijau dan tepung dengan menapisnya.', answer: true, exp: 'Tepung akan melepasi penapis kerana saiznya kecil, manakala kacang terperangkap.' },
    { type: 'mcq', image: 'images/fox_larut_cepat.png?v=2', q: 'Apakah alat yang paling sesuai digunakan untuk mencampurkan warna cecair?', options: ['Sudu (Kacauan)', 'Pisau', 'Gunting'], answer: 'Sudu (Kacauan)', exp: 'Mengacau mempercepatkan campuran sebati.' },
    { type: 'drag', image: 'images/fox_larut_cepat.png?v=2', q: 'Padankan kaedah pemisahan',
    ...
    { type: 'tf', image: 'images/fox_boleh_larut.png?v=2', q: 'Minyak akan bercampur sebati dengan air jika dikacau dengan lama.', answer: false, exp: 'Minyak tidak larut di dalam air. Ia akan sentiasa timbul di atas air.' },
    { type: 'mcq', image: 'images/fox_larut_cepat.png?v=2', q: 'Apakah yang terjadi jika kita memasukkan sehelai daun ke dalam air?', options: ['Daun larut', 'Daun tenggelam', 'Daun timbul (terapung)'], answer: 'Daun timbul (terapung)', exp: 'Daun lebih ringan dan kurang tumpat daripada air.' },
    { type: 'tf', image: 'images/fox_boleh_larut.png?v=2', q: 'Sudu besi akan tenggelam kerana ia lebih tumpat daripada air.', answer: true, exp: 'Bahan yang berat dan padat seperti besi akan tenggelam.' }
];
...
// UNIT 9: Bumi
const unit9Data = [
    { type: 'mcq', image: 'images/fox_sumber_air.png?v=2', q: 'Sumber air semula jadi untuk bumi datang dari mana?', options: ['Paip rumah', 'Hujan dan sungai', 'Kolam renang'], answer: 'Hujan dan sungai', exp: 'Hujan turun ke bumi dan mengalir ke sungai, tasik, dan laut sebagai sumber air semula jadi.' },
    { type: 'tf', image: 'images/fox_udara.png?v=2', q: 'Air sungai biasanya akan mengalir menuju ke laut.', answer: true, exp: 'Air mengalir dari kawasan tinggi ke kawasan rendah seperti laut.' },
    { type: 'drag', image: 'images/fox_angin.png?v=2', q: 'Susun urutan kitaran air',
    ...
    { type: 'mcq', image: 'images/fox_aliran_semula_jadi.png?v=2', q: 'Kawasan yang dipenuhi air masin yang sangat luas dinamakan...', options: ['Tasik', 'Laut', 'Sungai'], answer: 'Laut', exp: 'Laut membekalkan air masin yang meliputi 70% bumi.' },
    { type: 'tf', image: 'images/fox_aliran_air.png?v=2', q: 'Udara wujud di sekeliling kita walaupun kita tidak boleh melihatnya.', answer: true, exp: 'Udara tidak boleh dilihat tetapi boleh dirasai apabila angin bertiup.' },
    { type: 'drag', image: 'images/fox_aliran_semula_jadi.png?v=2', q: 'Kelaskan keadaan udara',
    ...
    { type: 'mcq', image: 'images/fox_angin.png?v=2', q: 'Apakah yang terjadi apabila angin bertiup kencang?', options: ['Pokok bergoyang', 'Bulan bersinar', 'Hujan berhenti'], answer: 'Pokok bergoyang', exp: 'Angin kencang menyebabkan pokok bergoyang kuat dan kadangkala boleh tumbang.' },
    { type: 'tf', image: 'images/fox_aliran_semula_jadi.png?v=2', q: 'Angin yang bertiup perlahan dipanggil bayu.', answer: true, exp: 'Angin sepoi-sepoi bahasa atau bayu sangat nyaman dirasai.' },
    { type: 'mcq', image: 'images/fox_kitaran_air.png?v=2', q: 'Angin ialah...', options: ['Cahaya dari matahari', 'Udara yang bergerak', 'Air yang mengalir'], answer: 'Udara yang bergerak', exp: 'Angin kuat boleh menyebabkan ombak dan tiupan pokok.' },
    { type: 'tf', image: 'images/fox_roket_angin.png?v=2', q: 'Bumi adalah planet yang bulat yang dipenuhi banyak air dan tanah.', answer: true, exp: 'Bentuk bumi adalah sfera (bulat) dan diliputi lebih banyak air daripada daratan.' }
];
...
// UNIT 10: Teknologi
const unit10Data = [
    { type: 'mcq', image: 'images/fox_manual.png?v=2', q: 'Apakah alat yang paling sesuai dipasang untuk membentuk sebuah kereta mainan maya?', options: ['Sayap', 'Tayar (Roda)', 'Bumbung rumah'], answer: 'Tayar (Roda)', exp: 'Tayar atau roda sangat penting untuk membolehkan kenderaan bergerak.' },
    { type: 'tf', image: 'images/fox_jurutera.png?v=2', q: 'Set binaan perlu dipasang mengikut arahan manual supaya bentuknya menjadi betul.', answer: true, exp: 'Manual bergambar disediakan sebagai panduan asas.' },
    { type: 'drag', image: 'images/fox_binaan_pilihan.png?v=2', q: 'Kelaskan bentuk asas binaan',
    ...
    { type: 'mcq', image: 'images/fox_kreatif.png?v=2', q: 'Komponen yang digunakan untuk memutarkan tayar dalam set binaan robotik selalunya ialah...', options: ['Motor elektrik', 'Mentol', 'Kertas'], answer: 'Motor elektrik', exp: 'Motor menggunakan elektrik (bateri) untuk menghasilkan pergerakan pusingan.' },
    { type: 'tf', image: 'images/fox_simpan_binaan.png?v=2', q: 'Selepas selesai bermain set binaan, kita boleh membiarkannya bersepah di atas lantai.', answer: false, exp: 'Komponen perlu dileraikan dan disimpan semula dengan kemas di dalam kotak.' },
    { type: 'mcq', image: 'images/fox_binaan_pilihan.png?v=2', q: 'Apakah faedah membina menggunakan set binaan?', options: ['Meningkatkan selera makan', 'Melatih pemikiran kreatif', 'Membuat mata rabun'], answer: 'Melatih pemikiran kreatif', exp: 'Membina rekaan dapat melatih otak dan tangan bekerjasama.' },
    { type: 'drag', image: 'images/fox_jurutera.png?v=2', q: 'Padankan fungsi',
    ...
    { type: 'tf', image: 'images/fox_kreatif.png?v=2', q: 'Set binaan hanya ada satu cara sahaja untuk dipasang.', answer: false, exp: 'Walaupun ada manual, kita boleh gunakan imaginasi untuk mencipta pelbagai bentuk lain.' },
    { type: 'mcq', image: 'images/fox_binaan_pilihan.png?v=2', q: 'Komponen berbentuk ____ sangat sesuai dijadikan badan kereta mainan.', options: ['Bebola', 'Segi empat', 'Cincin'], answer: 'Segi empat', exp: 'Bentuk blok kuboid (segi empat) stabil sebagai badan kenderaan.' },
    { type: 'tf', image: 'images/fox_manual.png?v=2', q: 'Bahagian yang tajam dalam set binaan perlu dipasang dengan berhati-hati supaya tidak cedera.', answer: true, exp: 'Keselamatan sentiasa diutamakan.' }
];
